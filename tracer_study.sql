...
--
-- Host: 127.0.0.1
-- Generation Time: 23 Mei 2024 pada 10.21
...
(1, 'Jl. Wisma Rini, No.09 Pringsewu, Lampung', '0729-22240', '0729-22240', 'admin@ibnus.ac.id', '', '', '', '', '', '');
...
(1, 'WELCOM TO TRACER - STUDY', 'Institut Bakti Nusantara Lampung', 'tracer study Institut Bakti Nusantara Lampung', 'tracer study', 'Capture_toga.PNG');
...
(1, NULL, 'MARDIYANTO', 'mardybest@gmail.com', '$2y$12$eEY.bjcCJu9CdjHCYpwQluiMYKoM0ta.EBMu5mLBH1/MVOdI4S5xW', '1', 1, 1, 1, ''),
