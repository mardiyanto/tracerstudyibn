...
class Auth extends CI_Controller
{
	...
	function _email_reset($email, $kode_aktivasi)
	{
		$config = [
			...
			'smtp_user' 	=> 'mardybest@ibnus.ac.id', // alamat email gmail anda
			'smtp_pass'   	=> 'buda atny ysmy msgr', // password gmail anda
			'smtp_crypto' 	=> 'ssl',
			'smtp_port'   	=> 465,
			'crlf'    		=> "\r\n",
			'newline' 		=> "\r\n"
		...
		$this->email->from('mardybest@ibnus.ac.id', 'admin'); //setting data pengirim disini! (email pengirim dan nama pengirim)
